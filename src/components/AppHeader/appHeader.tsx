...
const AppHeader: FC = () => {
    const linkActive = ({ isActive }: { isActive: boolean }) => isActive ? `${style.link} ${style.link_active} text text_type_main-default` : `${style.link}  text text_type_main-default text_color_inactive`
    const location = useLocation();
    const iconActive = (link: string) => {
